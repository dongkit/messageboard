...
class UsersController extends AppController {
	...
	public function index() {
		...
		$messages = $this->User->Message->find('all', array(
			'conditions' => array(
				'OR' => array(
					'user_id' => $this->Auth->user('id'), // main sender can see the convo
					'receiver_id' => $this->Auth->user('id') // receiver also can see the convo
				)
			),
	...
	public function getMessages($limit = 4) {
